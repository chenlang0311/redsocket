<template>
  <div class="emergentlist" id="deg90">
    <div class="fictlist">
      <div class="list_top">
        <div
          class="list_top-item"
      ...
      <div class="list_top list_bottom">
        ...
        >
          ...
          <img :src="item.src" alt class="item_img" :class="'item_img' + (i + 5)">
        </div>
      </div>
      <img src="../assets/img/early1/hengtiao.png" alt class="top_ht">
    </div>
    ...
    return {
      topList: [
        ...
        },
        {
          ...
          top: false,
          name: "Word  Search",
          src: require("../assets/img/fictionlist/list/5.png"),
      ...
      bottomList: [
        {
          id: 6,
          top: false,
          name: "I can Tell  the Story",
          src: require("../assets/img/fictionlist/list/6.png"),
